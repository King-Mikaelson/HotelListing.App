...
namespace HotelListing.Api.Controllers
{
    ...
    public class HotelsController : ControllerBase
    {
        ...
        {
            new Hotel { Id = 1, Name = "Grand Plaza", Address = "123 Main St", Rating = 5},
            new Hotel {Id = 2, Name = "Dracula's Castle", Address = "666 Dark Rd", Rating = 4.5}
        };
        ...
        public ActionResult<Hotel> Post([FromBody] Hotel newHotel)
        {
            ...
            {
                return Conflict("Hotel with this ID already exists");
            }
